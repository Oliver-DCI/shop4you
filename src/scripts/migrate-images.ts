...
// 📦 Deine 28 Originalen Produkte mit den Unsplash-Links
    ...
    for (const imageUrl of product.images) {
      ...
      try {
        ...
        const uploadResult = await cloudinary.uploader.upload(imageUrl, {
          ...
          // Optional: Automatische Optimierung beim Upload aktivieren
          quality: 'auto',
          fetch_format: 'auto'
        });
        ...
        // Fallback: Falls ein Upload fehlschlägt, behalten wir die Unsplash-URL
        newCloudinaryUrls.push(imageUrl);
      }
    }

    // Produkt mit den neuen URLs in das neue Array pushen
...
`;
  ...
  // 💾 Überschreibe die alte prisma/seed.ts mit den neuen Daten
