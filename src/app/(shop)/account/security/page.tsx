  ...
  return (
    <div className="flex flex-col gap-6 w-full text-black">
      <div>
        ...
        <p className="text-xs text-samsung-muted mt-1">Verwalte deine Passwörter und kryptografischen Identitäten.</p>
      </div>
      ...
      <form onSubmit={handlePasswordChange} className="flex flex-col gap-5 max-w-md w-full">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] font-medium text-samsung-muted uppercase tracking-widest">Aktuelles Passwort</label>
