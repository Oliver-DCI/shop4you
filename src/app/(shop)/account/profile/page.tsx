...
import ProfileWrapper from '@/components/shop/account/ProfileWrapper';
  ...
  return (
    <div className="flex flex-col gap-6 w-full text-black">
      <div>
        ...
        <p className="text-xs text-zinc-400 mt-1">Verwalte deine Identität und deine primäre Versandadresse.</p>
      </div>
