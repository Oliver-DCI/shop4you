    ...
    <div className="min-h-screen bg-zinc-50 text-black font-sans selection:bg-black selection:text-white">
      ...
      <div className="max-w-[1600px] mx-auto p-8 grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-1 flex flex-col gap-1">
          <p className="text-[10px] font-medium text-zinc-400 uppercase tracking-widest mb-4 px-2">Kommando-Zentrale</p>
          <button 
            onClick={() => setActiveTab('overview')}
            className={`w-full text-left px-4 py-3 text-xs uppercase tracking-widest border transition-colors cursor-pointer ${activeTab === 'overview' ? 'bg-black text-white border-black' : 'bg-white border-transparent text-zinc-500 hover:border-zinc-200 hover:text-black'}`}
          >
            📊 Live-Metriken & Umsatz
          </button>
          <button 
            onClick={() => setActiveTab('sellers')}
            className={`w-full text-left px-4 py-3 text-xs uppercase tracking-widest border transition-colors cursor-pointer ${activeTab === 'sellers' ? 'bg-black text-white border-black' : 'bg-white border-transparent text-zinc-500 hover:border-zinc-200 hover:text-black'}`}
          >
            🏢 Verkäufer (Seller)
          </button>
          <button 
            onClick={() => setActiveTab('import')}
            className={`w-full text-left px-4 py-3 text-xs uppercase tracking-widest border transition-colors cursor-pointer ${activeTab === 'import' ? 'bg-black text-white border-black' : 'bg-white border-transparent text-zinc-500 hover:border-zinc-200 hover:text-black'}`}
          >
            📥 25-Artikel Datenimport
          </button>
          <button 
            onClick={() => setActiveTab('admins')}
            className={`w-full text-left px-4 py-3 text-xs uppercase tracking-widest border transition-colors cursor-pointer ${activeTab === 'admins' ? 'bg-black text-white border-black' : 'bg-white border-transparent text-zinc-500 hover:border-zinc-200 hover:text-black'}`}
          >
            🛡️ Team & Admins
          </button>
        </div>
          ...
          {activeTab === 'overview' && (
            <div className="flex flex-col gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="border border-zinc-200 p-6 bg-zinc-50">
                  <p className="text-[10px] text-zinc-400 uppercase tracking-widest">Plattform-Umsatz (Take-Rate 10%)</p>
                ...
                <div className="border border-zinc-200 p-6 bg-zinc-50">
                  <p className="text-[10px] text-zinc-400 uppercase tracking-widest">Ø Warenkorbwert (AOV)</p>
                  <p className="text-2xl font-mono mt-2 font-light">642,10 €</p>
                  <span className="text-[9px] text-zinc-400 uppercase tracking-widest mt-1 inline-block">High-End Hardware Fokus</span>
                </div>
                <div className="border border-zinc-200 p-6 bg-zinc-50">
                  <p className="text-[10px] text-zinc-400 uppercase tracking-widest">Kunden-Konvertierungsrate</p>
              ...
              <div className="border border-zinc-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs pt-4 mt-2">
                  <div className="border-l-2 border-black pl-4 py-2">
                    ...
                    <p className="text-[9px] text-zinc-400 uppercase tracking-wider mt-0.5">Anteil am Marktplatz: 85.2%</p>
                  </div>
                  <div className="border-l-2 border-zinc-400 pl-4 py-2">
                    ...
                    <p className="text-[9px] text-zinc-400 uppercase tracking-wider mt-0.5">Anteil am Marktplatz: 11.8%</p>
                  </div>
                  <div className="border-l-2 border-zinc-200 pl-4 py-2">
                    ...
                    <p className="text-lg font-light mt-1 text-zinc-400">3.100 €</p>
                    <p className="text-[9px] text-zinc-400 uppercase tracking-wider mt-0.5">Anteil am Marktplatz: 3.0%</p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'import' && (
            <div className="flex flex-col gap-6">
              <div>
                ...
                <p className="text-zinc-400 text-[10px] uppercase tracking-widest mt-1">Einspeisung von 25 vordefinierten High-End Tech-Artikeln in die Datenbank</p>
              </div>
              <div className="border border-dashed border-zinc-300 p-8 text-center flex flex-col items-center justify-center bg-zinc-50">
                ...
                <p className="text-[10px] text-zinc-400 uppercase tracking-widest mt-1 mb-6">Prüft Kategorien, Bilder-URLs und setzt Standard-Lagerbestände</p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-zinc-400 text-[10px] uppercase tracking-widest mt-1">Berechtigte Teammitglieder für das Marktplatz-HQ</p>
                </div>
                <button 
