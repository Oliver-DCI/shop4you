...
const INITIAL_TEMPLATE = [
  ...
  { title: 'UltraBook Pro 14', description: 'Extrem dünnes Gehäuse, federleicht mit CNC-Aluminium-Finish und brillantem Display.', price: 1499.00, category: 'Notebooks', brand: 'Asus', stock: 15, images: ['https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=800', '', '', ''] },
  { title: 'S4Y Phone Matrix', description: 'Unser hauseigenes Flaggschiff mit nativer Hardware-Verschlüsselung und Quantum-Kamera.', price: 999.00, category: 'Smartphones', brand: 'Google', stock: 30, images: ['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800', '', '', ''] },
  ...
  { title: 'S4Y SoundBar Pro X', description: 'Kompakte Soundbar mit immersivem Raumklang und drahtlosem Subwoofer.', price: 549.00, category: 'Audio', brand: 'Samsung', stock: 12, images: ['https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800', '', '', ''] },
